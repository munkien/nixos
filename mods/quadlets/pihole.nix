...
in
{
  ...
  # Define the secret in your SOPS file, and template it into an env file
  ...
  # Variables injected into networking
  ...
  virtualisation.quadlet.containers.pihole = lib.recursiveUpdate common {
    containerConfig = {
      ...
      # Variable injected into healthcheck
      ...
      # Quadlet pulls the SOPS template natively at boot
      ...
      environments = {
        ...
        # Variable injected into DNS records
        FTLCONF_dns_hosts = ''
