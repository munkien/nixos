{
  ...
  persistDir =
    ...
    then "${config.my.impermanence.persistPath}/services/paperless-ngx"
    else "/var/lib/paperless-ngx";
  paperlessPort = 28981;
in {
  options.my.services.paperless.enable = lib.mkEnableOption "Paperless Document Management";
